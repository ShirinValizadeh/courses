...
class CourseRatingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create course_rating" do
    assert_difference('CourseRating.count') do
      post course_ratings_url, params: { course_rating: { course_id: @course_rating.course_id, rating: @course_rating.rating } }
    end
  ...
  test "should update course_rating" do
    patch course_rating_url(@course_rating), params: { course_rating: { course_id: @course_rating.course_id, rating: @course_rating.rating } }
